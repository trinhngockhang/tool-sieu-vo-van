...
class InvationVideo extends Component{
  constructor(props){
    super(props);
  ...
  async invite(){
    const result = await Puppeteer.inviteVideo(this.refs.linkInput.value);
  ...
  render(){
    return(
      <div className="d-flex flex-column function-box">
        <h2 className="title">Link video to invite</h2>
